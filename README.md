...
**macOS, Apple Silicon:** [QA-Scout-0.1.91-mac-arm64.zip](https://github.com/asxyw/qa-scout-app/releases/download/v0.1.91/QA-Scout-0.1.91-mac-arm64.zip)

**Windows, x64:** [QA-Scout-0.1.91-win-x64.zip](https://github.com/asxyw/qa-scout-app/releases/download/v0.1.91/QA-Scout-0.1.91-win-x64.zip)
